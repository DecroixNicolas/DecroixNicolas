...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .img-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 15px; margin-top: 20px; }
    ...
    .img-item img { width: 100%; height: 220px; object-fit: cover; display: block; background: #0f172a; }
  ...
  <main>
    ...
    <section id="parcours" class="tab-pane">
      ...
      <div class="card">
        ...
        <ul>
          ...
          <li>Travail en environnement international (production en anglais).</li>
        </ul>
      </div>
      ...
      <div class="card">
        ...
        <ul>
          ...
          <li>Application stricte des protocoles de haute confidentialité.</li>
        </ul>
      </div>
      ...
      <div class="card">
        ...
        <p>Mairie de Caluire-et-Cuire</p>
        <ul>
          <li>Recherche pour l’implantation de production d'énergie solaire urbaine.</li>
          <li>Rédaction de notes et rapports décisionnels pour la municipalité.</li>
          <li>Utilisation opérationnelle de SIG (ArcGIS, QGIS).</li>
        </ul>
      </div>
    </section>
    ...
    <section id="recherche" class="tab-pane">
      ...
      <div class="card">
        ...
        <p><em>"La militarisation de la frontière russo-polonaise avec Kaliningrad"</em></p>
        
        <div style="background: rgba(56, 189, 248, 0.1); padding: 20px; border-radius: 10px; border: 1px dashed var(--accent); margin-bottom: 25px;">
          <p style="font-size: 15px; margin-bottom: 10px;">🌍 <strong>Travail de terrain :</strong> Cet article documente ma visite scientifique à l'Université d'Olsztyn (Pologne), détaillant mes échanges avec les chercheurs locaux et les autorités sur les enjeux de sécurité frontalière.</p>
          <a href="http://wns.uwm.edu.pl/inp/wizyta-naukowa-studenta-z-francji" target="_blank" class="action-btn">Consulter l'article de terrain ↗</a>
        </div>
        ...
        <div class="img-grid">
          <div class="img-item">
            <img src="Carte-Région.png" alt="Analyse Régionale" onerror="this.src='https://via.placeholder.com/500x320/1e293b/38bdf8?text=Cartographie+Régionale'">
            <div class="img-tag">Échelle Régionale</div>
          </div>
          <div class="img-item">
            <img src="Carte-Varmie.png" alt="Analyse Locale" onerror="this.src='https://via.placeholder.com/500x320/1e293b/38bdf8?text=Cartographie+Locale'">
            <div class="img-tag">Échelle Locale (Varmie-Mazurie)</div>
          </div>
        </div>
      </div>
